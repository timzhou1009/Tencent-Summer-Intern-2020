-- 新作者/回流作者冷启消费
    ...
    from (
        ...
        (
            ...
            where imp_date=20200606 and last_time>date_sub(20200606,14)
        ) e
        ...
        (
            ...
            where dt=20200606 and is_first_pub=1
        ) f
    ...
    (
        ...
        where dt=20200606 and is_recommend=1 and recommend_id_map['sourceid']='459'
    ) a
